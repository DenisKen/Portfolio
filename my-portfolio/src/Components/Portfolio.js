        ...
        <div className="row">
          ...
          <div className="twelve columns collapsed">
              ...
              <div className="overlay">
                ...
                <h5 className="portfolio-text">TIKI</h5>
                ...
                <div className="portfolio-item-meta">
                  <h5 className="portfolio-text">LISY - A LIPSYNC SOFTWARE</h5>
                  <p className="portfolio-text">
                ...
                <div className="portfolio-item-meta">
                  <h5 className="portfolio-text">VIDEO BOT</h5>
                  <p className="portfolio-text">
                ...
                <div className="portfolio-item-meta">
                  <h5 className="portfolio-text">CONAREC - VR GOOGLE DREAM</h5>
                  <p className="portfolio-text">
